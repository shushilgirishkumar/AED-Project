...
public class Studentde {
    ...
    public void setPassword(String Password) {
     ...
     public Studentde(String name, int age, String Campus, String Specalization, String email_Id, int phoneno,String Term, String Acceptedyear, String Gradyear, String NEUID, String Password){
        this.name = name;
        this.age = age;
        this.Campus = Campus;
        this.Acceptedyear = Acceptedyear;
